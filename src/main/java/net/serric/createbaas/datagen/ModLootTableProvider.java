...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        //addDrop(); this is used to make a block drop itself

        addDrop(ModBlocks.TIN_ORE, oreDrops(ModBlocks.TIN_ORE, ModItems.RAW_TIN));
        addDrop(ModBlocks.DEEPSLATE_TIN_ORE, copperLikeOreDrops(ModBlocks.DEEPSLATE_TIN_ORE, ModItems.RAW_TIN, 2f, 3f));
    }
